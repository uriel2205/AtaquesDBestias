...
Haz matados <color=#cc3333ff><size=50>{0}</size></color> Enemigos

Puntaje mas alto: <color=#cc3333ff><size=50>{1}</size></color>

Presiona <size=50><color=#cc3333ff>[ESC]</color></size> para continuar",
						currentKillNum,
						highScore
					);
		...
		public void FreshBar () {
			...
			HPBarTXT.text = string.Format(
				"{0}/{1}  Enemigo en el area  <color=#ddddddff><size=16>{2} segundos/enemigo</size></color>",
